...
router.delete('/:id', authorizeRoles('admin', 'security'), require('../controllers/visitorController').deleteVisitor);
router.post('/update-status', authorizeRoles('admin', 'security', 'staff'), require('../controllers/visitorController').updateVisitorStatus);
